...
.dsat-module{position:relative;border:1px solid rgba(127,127,127,.16);border-radius:10px;padding:8px;min-width:0;}
...
@media(max-width:900px){.dsat-size-small{grid-column:span 6}.dsat-size-medium{grid-column:span 12}}
@media(max-width:680px){.dsat-size-small,.dsat-size-medium,.dsat-size-large{grid-column:span 12}.dsat-account-summary{align-items:flex-start}}
