...
if (React !== null) {
  ...
  function writeFilters(filters) { try { localStorage.setItem('dsat-filters', JSON.stringify(filters)) } catch (e) {} }
  function readLayout() {
    try {
  ...
  function writeLayout(layout) { try { localStorage.setItem('dsat-layout', JSON.stringify(layout)) } catch (e) {} }
  ...
  function LayoutSettings(props) {
    ...
    return el('div', { className: 'dsat-body' },
      ...
      el('div', { className: 'dsat-settings-help' }, '拖动上方宽度滑块调整面板；每个模块可关闭、调整大小，并用上下按钮调整位置。设置保存在当前浏览器。'),
  ...
  function ActivityPanel(props) {
    ...
    React.useEffect(function () {
      writeFilters({ project: project, scope: scope, customStart: customStart, customEnd: customEnd, page: rangePage })
    }, [project, scope, customStart, customEnd, rangePage])
    React.useEffect(function () {
              ...
              return el('div', { className: 'dsat-body dsat-dashboard-grid' }, layout.order.map(function (id) {
                return layout.modules[id] && layout.modules[id].enabled !== false
                  ? el('section', { className: moduleClass(layout, id), key: id, draggable: true,
                      ...
                      onDragOver: function (e) { e.preventDefault() }, onDrop: function (e) { dropDashboardModule(e, id) } }, moduleContent[id])
                  : null
...
.dsat-module{border:1px solid rgba(127,127,127,.16);border-radius:10px;padding:8px;min-width:0;}
